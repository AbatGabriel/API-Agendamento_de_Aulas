...
Essa aplicação consiste em um backend para a administração de agendamento de aulas de alunos com instrutores. A partir dessa aplicação, é possível cadastrar dados de alunos e instrutores, edita-los e deleta-los, além de adquirir informações úteis como, por exemplo, os horários disponíveis de cada instrutor.
