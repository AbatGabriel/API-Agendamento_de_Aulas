...
describe('main tests', () => {
    ...
    describe('loginStudent', () => {
        ...
        it('should throw "Please Provide email and password!"', async () => {
            ...
            await expect(loginStudent(mockRequest as Request, mockResponse as Response)).rejects.toThrowError('Please Provide email and password!');
        });
        ...
        it('should throw an error if student is not found', async () => {
            ...
            jest.spyOn(StudentModel, 'findOne').mockReturnValueOnce({
                exec: jest.fn().mockResolvedValue(null), // Simulando que o usuário não foi encontrado
            } as any);

            await expect(loginStudent(mockRequest as Request, mockResponse as Response)).rejects.toThrowError('Invalid Credentials!');
        });
        ...
        it('should throw an error if password does not match', async () => {
            ...
            // Fazendo mock para o comparePassword retornar falso (senhas não correspondem)
    ...
    describe('loginInstructor', () => {
        ...
        it('should throw "Please Provide email and password!"', async () => {
            ...
            await expect(loginInstructor(mockRequest as Request, mockResponse as Response)).rejects.toThrowError('Please Provide email and password!');
        });
        ...
        it('should throw an error if Instructor is not found', async () => {
            ...
            await expect(loginInstructor(mockRequest as Request, mockResponse as Response)).rejects.toThrowError('Invalid Credentials!');
        });
